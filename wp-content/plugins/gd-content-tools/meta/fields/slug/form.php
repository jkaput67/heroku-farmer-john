<table class="form-table">
    <tbody>
        <tr>
            ...
            <td>
                <input class="widefat gdcet-field-slug gdcet-field-property-settings-default" name="gdcet[field][fields][<?php echo $field_id; ?>][settings][default]" type="text" value="<?php echo esc_attr($this->settings['default']); ?>" />
                <p class="description">
