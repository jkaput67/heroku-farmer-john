(function ($) {
    ...
    Lightbox.prototype.structure = function (index) {
        ...
        switch($object.settings.lightboxView){
            ...
            case 'view2':
            case 'view3':
                var $h = 2*Math.abs(portfolio_resp_lightbox_obj.portfolio_gallery_lightbox_imageshadowv) + 92, $t;

                if(portfolio_resp_lightbox_obj.portfolio_gallery_lightbox_imageshadowv < 0){
                    $t = Math.abs(portfolio_resp_lightbox_obj.portfolio_gallery_lightbox_imageshadowv) + 47;
                } else {
                    $t = 47;
                }
                $inner.css({
        ...
        if (this.settings.download) {
            ...
            switch (this.settings.lightboxView) {
                ...
                case 'view2':
                    ...
                    break;
                case 'view4':
                    $('<a id="' + $object.settings.classPrefix + 'download" target="_blank" download class="' + this.settings.classPrefix + 'download ' + $object.settings.classPrefix + 'icon">' + $download_bg + '</a>').appendTo($('.rwd-toolbar'));
                    break;
                case 'view5':
                case 'view6':
        ...
        if(portfolio_resp_lightbox_obj.portfolio_gallery_lightbox_rightclick_protection){
            setTimeout(function () {
                $('.rwd-container').bind('contextmenu', function () {
                    return false;
                });
    ...
    Lightbox.prototype.socialShare = function () {
        ...
        var shareButtons = '<ul class="rwd-share-buttons" style="display: none;">';
        ...
        if (this.settings.lightboxView === 'view5' || this.settings.lightboxView === 'view6') {
            ...
            $('.contInner .rwd-share-buttons').show();
        } else {
    ...
    Lightbox.prototype.slideShow = function () {
        ...
        switch (this.settings.lightboxView) {
            ...
            case 'view3':
                ...
                break;
            case 'view4':
                $('<span class="' + $object.settings.classPrefix + 'autoplay-button ' + $object.settings.classPrefix + 'icon">' + $play_bg + $pause_bg + '</span>').appendTo($('.rwd-toolbar'));
                $('.rwd-toolbar .rwd-icon').addClass('rwd-icon0');
                break;
        }
    ...
    Lightbox.prototype.closeGallery = function () {
        ...
        if ($object.settings.overlayClose) {
            ...
            $object.$cont.on('mouseup.rwd-container', function (e) {
                ...
                if ($(e.target).is('.contInner' + $object.settings.classPrefix + 'cont') || $(e.target).is('.' + $object.settings.classPrefix + 'item ') || $(e.target).is('.' + $object.settings.classPrefix + 'img-wrap') && mousedown) {
