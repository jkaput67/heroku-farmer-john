...
class Portfolio_Gallery_Admin_Assets {
	...
	public function admin_styles( $hook ){
		if( in_array($hook, Portfolio_Gallery()->admin->pages ) ){
			wp_enqueue_style( "portfolio_gallery_admin_css", Portfolio_Gallery()->plugin_url()."/assets/style/admin.style.css", false );
			...
			wp_enqueue_style( "portfolio_gallery_featured_plugins", Portfolio_Gallery()->plugin_url()."/assets/style/featured-plugins.css",  false );
		}
		$edit_pages = array('post.php','post-new.php');
		if ( in_array( $hook, $edit_pages ) ){
			wp_enqueue_style( "portfolio_gallery_add_shortecode_css", Portfolio_Gallery()->plugin_url() . "/assets/style/shortecode.css", false );
		}
	}
