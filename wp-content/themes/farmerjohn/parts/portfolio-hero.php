<?php
/**
 * The portfolio hero template
 */
?>

<style>
.baconparty_hero {
    background-image: url(http://www.farmerjohn.com/wp-content/uploads/2017/12/baconparty-hero.jpg);
...
@media screen and (max-width: 1090px) {
	.headerimage-bp {max-width:550px;}
}
a.bacon_party_button {
    color: #ffffff;
