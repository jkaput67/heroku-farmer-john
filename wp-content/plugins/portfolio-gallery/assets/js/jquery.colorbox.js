...
(function ($, document, window) {
	...
	publicMethod.close = function () {
		...
		var portfolioId;
		jQuery('.p-main-slider').each(function(){
			portfolioId = jQuery(this).attr('data-portfolio-id');
			var liquidSliderInterval = jQuery(this).attr('data-slide-interval');
			var autoslide = jQuery(this).attr('data-autoslide');
			if(autoslide == 'on') {
				if (jQuery('#p-main-slider_' + portfolioId)[0]) {
					var api = jQuery.data(jQuery('#p-main-slider_' + portfolioId)[0], 'liquidSlider');
					setTimeout(function () {
						api.startAutoSlide();
					}, liquidSliderInterval);
				}
			}
		});
