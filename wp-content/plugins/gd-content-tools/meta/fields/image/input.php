<div class="gdcet-imagefile-wrapper">
    ...
    <div class="gdcet-imagefile-buttons">
        <a href="#" class="gdcet-button gdcet-imagefile-add"><i class="dashicons dashicons-format-image"></i> <?php _e("Select", "gd-content-tools"); ?></a>
        <a style="display: <?php echo $image_id > 0 ? "inline-block" : "none"; ?>" href="#" class="gdcet-button gdcet-imagefile-preview"><i class="dashicons dashicons-editor-expand"></i> <?php _e("Preview", "gd-content-tools"); ?></a>
    ...
    <div class="gdcet-imagefile-preview-area">
        ...
        $url = '';
        $title = __("Image not selected.", "gd-content-tools");
