...
<?php endif; ?>
	margin-bottom: 25px;
	height: <?php echo $portfolio_gallery_get_options['portfolio_gallery_ht_view7_thumbnail_height']; ?>px;
...
#huge_it_portfolio_content_<?php echo $portfolioID; ?> .og-expander ul.elastislide-list li > a > img {
	...
	max-width: none;
	max-height: none;
	border: solid 2px #<?php echo $portfolio_gallery_get_options['portfolio_gallery_ht_view7_thumbnail_bg_color']; ?>;
}
...
#huge_it_portfolio_content_<?php echo $portfolioID; ?> .og-expander .og-details h3 {
	color: #<?php echo $portfolio_gallery_get_options['portfolio_gallery_ht_view7_expand_block_title_color']; ?>;
	font-size: <?php echo $portfolio_gallery_get_options['portfolio_gallery_ht_view7_expand_block_title_font_size']; ?>px;
	line-height: normal;
}
