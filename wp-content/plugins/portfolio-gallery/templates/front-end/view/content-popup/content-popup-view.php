                ...
                <ul class=" clearfix sort-by-button-group">
                    <?php if ($portfolio_gallery_get_options["portfolio_gallery_ht_view2_sorting_name_by_default"] != ''): ?>
                        <li><a href="#sortBy=original-order" data-option-value="original-order" class="selected"
                            ><?php echo esc_attr($portfolio_gallery_get_options["portfolio_gallery_ht_view2_sorting_name_by_default"]); ?></a>
                        </li>
                    <?php endif; ?>
    ...
    <div id="huge_it_portfolio_container_<?php echo esc_attr($portfolioID); ?>"
        ...
        foreach ($images as $key => $row) {
            ...
            <div id="huge_it_portfolio_pupup_element_<?php echo esc_attr($row->id); ?>_child"
                ...
                <div class="image-block image-block_<?php echo esc_attr($portfolioID); ?>">
                    ...
                    <?php if ($row->image_url != ';') {
                        switch (portfolio_gallery_youtube_or_vimeo_portfolio($imgurl[0])) {
                            case 'image': ?>
                                <img alt="<?php echo $row->name; ?>" id="wd-cl-img<?php echo esc_attr($key); ?>"
                ...
                <?php if ($portfolio_gallery_get_options["portfolio_gallery_ht_view2_image_title"] == 'on' && ($row->name != '' || $row->sl_url != '')): ?>
                    <div class="title-block_<?php echo $portfolioID; ?>">
                        ...
                        <?php if ($portfolio_gallery_get_options["portfolio_gallery_ht_view2_element_show_linkbutton"] == 'on' && $link != '') { ?>
                            <div class="button-block"><a
                                    ...
                                    echo 'target="_blank"';
                                } ?> ><?php echo esc_attr($portfolio_gallery_get_options["portfolio_gallery_ht_view2_element_linkbutton_text"]); ?></a>
                            </div>
                        <?php } ?>
                    </div>
                <?php endif; ?>
                    ...
                    if ($row->image_url != ';') {
                        switch (portfolio_gallery_youtube_or_vimeo_portfolio($imgurl[0])) {
                            case 'image':
                                ...
                                <?php if ($portfolio_gallery_get_options["portfolio_gallery_ht_view2_image_title"] == 'on') { ?>
                                <h3 class="imgTitle">
                                    <?php

                                    echo portfolio_gallery_get_image_title($imgurl[0]);
                                    ?>
                                </h3>
                            <?php }
                                break;
                                            ...
                                            case 'image':
                                                ...
                                                <a href="<?php echo esc_url($img); ?>"
                                                   ...
                                                   title="<?php echo esc_attr($row->name); ?>"
                                                    <?php if ($portfolio_gallery_get_options["portfolio_gallery_ht_view2_image_title"] == 'on') { ?>
                                                        data-imgTitle="<?php echo portfolio_gallery_get_image_title($img); ?>" <?php } ?> >
                                                    <img
