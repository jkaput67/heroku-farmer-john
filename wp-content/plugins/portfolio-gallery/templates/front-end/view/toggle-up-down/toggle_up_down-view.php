...
?>
<section id="huge_it_portfolio_content_<?php echo esc_attr($portfolioID); ?>" style="clear: both"
    ...
    <div id="huge_it_portfolio_options_and_filters_<?php echo esc_attr($portfolioID); ?>">
        ...
        <?php if ($portfolioShowSorting == "on") { ?>
            <div id="huge_it_portfolio_options_<?php echo esc_attr($portfolioID); ?>"
                ...
                <ul id="sort-by" class=" clearfix sort-by-button-group" data-option-key="sortBy">
                    <?php if ($portfolio_gallery_get_options["portfolio_gallery_ht_view0_sorting_name_by_default"] != ''): ?>
                        <li><a href="#sortBy=original-order" data-option-value="original-order" class="selected"
                               data><?php echo esc_attr($portfolio_gallery_get_options["portfolio_gallery_ht_view0_sorting_name_by_default"]); ?></a>
                        </li>
                    <?php endif; ?>
        ...
        if ($portfolioShowFiltering == "on") { ?>
            <div id="huge_it_portfolio_filters_<?php echo esc_attr($portfolioID); ?>"
                ...
                <ul>
                    <li rel="*">
                        <a><?php echo esc_attr($portfolio_gallery_get_options["portfolio_gallery_ht_view0_cat_all"]); ?></a>
                    </li>
                    <?php
    ...
    <div id="huge_it_portfolio_container_<?php echo esc_attr($portfolioID); ?>"
        ...
        foreach ($images as $key => $row) {
            ...
            <div
                ...
                <div class="default-block_<?php echo esc_attr($portfolioID); ?> <?php echo esc_attr($lighboxable); ?>"
                     style="<?php if ($row->name == '' && count($imgurl) < 3 && $imgurl[1] == '' && $row->description == '' && $link == '') echo "height:" . $portfolio_gallery_get_options['portfolio_gallery_ht_view0_block_height'] . "px !important;"; ?>">
                        ...
                        if ($row->image_url != ';') {
                            switch (portfolio_gallery_youtube_or_vimeo_portfolio($imgurl[0])) {
                                ...
                                case 'vimeo':
                                    ...
                                    ?>
                                    <a href="<?php echo $hasSSL; ?>://player.vimeo.com/video/<?php echo esc_attr($videourl[0]); ?>"
                                       data-description=" <?php echo esc_attr($row->description); ?>"
                    ...
                    <div class="title-block title-block_<?php echo esc_attr($portfolioID); ?>">
                        <h3 class="name" title="<?php echo esc_attr($row->name); ?>"
                            class="title"><?php echo $row->name; ?></h3>
                        <div class="open-close-button"></div>
                    </div>
                </div>

                <div class="wd-portfolio-panel wd-portfolio-panel_<?php echo esc_attr($portfolioID); ?>"
                                        ...
                                        switch (portfolio_gallery_youtube_or_vimeo_portfolio($img)) {
                                            case 'image':
                                                ...
                                                <a href="<?php echo esc_attr($img); ?>"
                                                   ...
                                                   data-groupID="<?php echo esc_attr($group_key); ?>"><img
                                                            alt="<?php echo esc_attr($row->name); ?>"
                                                            data-title=" <?php echo portfolio_gallery_get_image_title($img); ?>"
                                                            src="<?php echo esc_url(portfolio_gallery_get_image_by_sizes_and_src($img, array($portfolio_gallery_get_options['portfolio_gallery_ht_view0_thumbs_width']), true)); ?>"></a>
                                                <?php
                                                break;
                                            case 'youtube':
                                        ...
                                        switch (portfolio_gallery_youtube_or_vimeo_portfolio($img)) {
                                            case 'image':
                                                ...
                                                <a href="<?php echo esc_url($img); ?>"
                                                   data-description=" <?php echo esc_attr($row->description); ?>"
                                                   class=" portfolio-group<?php echo esc_attr($group_key); ?> "><img
                                                            alt="<?php echo esc_attr($row->name); ?>"
                                                            data-title=" <?php echo portfolio_gallery_get_image_title($img); ?>"
                                                            src="<?php echo esc_url(portfolio_gallery_get_image_by_sizes_and_src($img, array($portfolio_gallery_get_options['portfolio_gallery_ht_view0_thumbs_width']), true)); ?>"></a>
                                                <?php
