...
function portfolio_gallery_get_default_general_options()
{
    $portfolio_gallery_default__params = array(
        ...
        'portfolio_gallery_ht_view2_image_title' => 'off',
        ...
        'portfolio_gallery_ht_view5_main_image_width' => '40',
        ...
        'portfolio_gallery_ht_view0_elements_in_center' => 'on',
        ...
        'portfolio_gallery_port_natural_size_toggle' => 'crop',
...
{
    $portfolio_gallery_get_default_options = portfolio_gallery_get_default_general_options();
    $portfolio_gallery_get_options = array();
    foreach ($portfolio_gallery_get_default_options as $name => $value) {
        $portfolio_gallery_get_options[$name] = get_option($name);
    }

    return $portfolio_gallery_get_options;
}
...
function portfolio_gallery_get_portfolio_by_id($id)
{
    global $wpdb;
