...
jQuery(function () {
    ...
    jQuery.fn.elastic_grid = function (config) {
        ...
        var portfolio_categories = portfolio.categories;
        portfolio_categories = portfolio_categories.split(',');
        ...
        if (numOfTag > 1) {
            ...
            jQuery.each(portfolio_categories, function (key, value) {
                createList(value);
            })
        } else {
        ...
        Preview.prototype = {
                        ...
                        carousel.append(ObjUl).find('.related_photo').bind('click', function () {
                            ...
                            if (jQuery(this).data('large')) {
                                ...
                                if (self.$fullimage.find('iframe:first').length) {
                                    ...
                                    setTimeout(function () {
                                        self.$fullimage.find('iframe:first').fadeIn(500, function () {
                                            self.$loading.hide();
                                        });
                                    }, 500);
            ...
            setHeights: function () {
                ...
                if (jQuery(window).width() > 767) {
                    ...
                    self.itemHeight = self.$item.data('height') + blockHeight + 80;
                }
                else {
                    self.$previewEl.css('height', detailsHeight + imgHeight + 60);
                    self.itemHeight = self.$item.data('height') + detailsHeight + imgHeight + 80;
                }
