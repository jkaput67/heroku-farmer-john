<table class="form-table">
    <tbody>
        ...
        <tr style="<?php echo $this->settings['custom'] ? '' : 'display: none;'; ?>">
            ...
            <td>
                <input class="widefat gdcet-half-field gdcet-datetime-datetime gdcet-field-property-settings-default" name="gdcet[field][fields][<?php echo $field_id; ?>][settings][default]" type="text" value="<?php echo esc_attr($this->settings['default']); ?>" />
                <p class="description">
