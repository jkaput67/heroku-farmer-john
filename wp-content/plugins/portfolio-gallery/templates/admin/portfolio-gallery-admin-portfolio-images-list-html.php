					...
					<div id="post-body-content">
						...
						<div id="post-body">
							<div id="post-body-heading">
								<div id="img_preview">
									...
									<label for="img_hover_preview"><?php _e('Image preview on hover','portfolio-gallery'); ?>
										<input type="checkbox" id="img_hover_preview" name="portfolio_gallery_admin_image_hover_preview"
										       value="on" <?php if ( $portfolio_gallery_get_option['portfolio_gallery_admin_image_hover_preview'] == 'on' )
											echo 'checked' ?>>
									</label>
								</div>
								...
								<span
									class="wp-media-buttons-icon"></span><?php echo __( 'Add Video', 'portfolio-gallery' ); ?>
								</a>
							</div>
