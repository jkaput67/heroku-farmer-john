...
<div id="p-main-slider_<?php echo esc_attr($portfolioID); ?>"
     class="portfolio-gallery-content p-main-slider liquid-slider view-<?php echo esc_attr($view_slug); ?>"
    ...
    foreach ($images as $key => $row) {
        ...
        $group_key0 = $group_key1 . "-" . $portfolioID;
        array_pop($imgurl);
        $link = $row->sl_url;
        ...
        <div class="slider-content">
            <div class="slider-content-wrapper slide_number<?php echo esc_attr($group_key1); ?>">
                <div class="image-block_<?php echo esc_attr($portfolioID); ?>">
                    ...
                    if ($row->image_url != ';') {
                        switch (portfolio_gallery_youtube_or_vimeo_portfolio($imgurl[0])) {
                            case 'image':
                                ...
                                ?>
                                <a class="portfolio-group<?php echo esc_attr($group_key0); ?> portfolio-group-slider_<?php echo esc_attr($portfolioID); ?>_<?php echo esc_attr($group_key1); ?>"
                                   href="<?php echo esc_url($imgurl[0]); ?>"
                                   data-description=" <?php echo esc_attr($row->description); ?>"
                                   title="<?php echo esc_attr($row->name); ?>"
                                   data-groupID="<?php echo esc_attr($group_key0); ?>"><img
                            ...
                            case 'youtube':
                                ...
                                <a href="https://www.youtube.com/embed/<?php echo $videourl[0]; ?>"
                                   data-description=" <?php echo esc_attr($row->description); ?>"
                                   class="portfolio-group<?php echo $group_key0; ?> huge_it_portfolio_item pyoutube portfolio-group-slider_<?php echo esc_attr($portfolioID); ?>_<?php echo esc_attr($group_key1); ?> add-H-relative add-H-block"
                                   title="<?php echo esc_attr($row->name); ?>"
                                   data-groupID="<?php echo esc_attr($group_key0); ?>">
                            ...
                            case 'vimeo':
                                ...
                                ?>
                                <a class="portfolio-group<?php echo $group_key0; ?> huge_it_portfolio_item pvimeo portfolio-group-slider_<?php echo esc_attr($portfolioID); ?>_<?php echo esc_attr($group_key1); ?>   add-H-relative add-H-block"
                    ...
                    <?php if ($portfolio_gallery_get_options["portfolio_gallery_ht_view5_show_thumbs"] == 'on') { ?>
                        <div>
                                ...
                                foreach ($imgurl as $key => $img) {
                                    switch (portfolio_gallery_youtube_or_vimeo_portfolio($img)) {
                                        case 'image':
                                            ?>
                                            <li>
                                                <a class="portfolio-group<?php echo $group_key0; ?> portfolio-group-slider_<?php echo esc_attr($portfolioID); ?>_<?php echo esc_attr($group_key1); ?>"
                                                   data-description=" <?php echo esc_attr($row->description); ?>"
                                        ...
                                        case 'youtube':
                                            ...
                                            <li>
                                                <a href="https://www.youtube.com/embed/<?php echo esc_attr($videourl[0]); ?>"
                                                   data-description=" <?php echo esc_attr($row->description); ?>"
                                                   class="portfolio-group<?php echo esc_attr($group_key0); ?> huge_it_portfolio_item pyoutube portfolio-group-slider_<?php echo esc_attr($portfolioID); ?>_<?php echo esc_attr($group_key1); ?>  add-H-relative"
                                                   data-groupID="<?php echo esc_attr($group_key0); ?>">
                                        ...
                                        case 'vimeo':
                                            ...
                                            $imgsrc = $hash[0]['thumbnail_large']; ?>
                                            <li>
                                                <a class="portfolio-group<?php echo esc_attr($group_key0); ?> huge_it_portfolio_item pvimeo portfolio-group-slider_<?php echo esc_attr($portfolioID); ?>_<?php echo $group_key1; ?>  add-H-relative"
