				...
				<table class="wp-list-table widefat fixed pages" style="width:95%">
					...
					for ( $i = 0; $i < count( $rows ); $i ++ ) {
						...
						if ( isset( $rows[ $i - 1 ]->id ) ) {
							...
							if ( $ka0 ) {
								$move_up = '<span><a href="#reorder" onclick="return portfolioGalleryYoutubeParser(\'' . $x1 . '\',\'' . $x2 . '\')" title="Move Up">   <img src="' . plugins_url( 'images/uparrow.png', __FILE__ ) . '" width="16" height="16" border="0" alt="Move Up"></a></span>';
							} else {
								$move_up = "";
							}
						} else {
						...
						if ( isset( $rows[ $i + 1 ]->id ) ) {
							...
							if ( $ka1 ) {
								$move_down = '<span><a href="#reorder" onclick="return portfolioGalleryYoutubeParser(\'' . $x1 . '\',\'' . $x2 . '\')" title="Move Down">  <img src="' . plugins_url( 'images/downarrow.png', __FILE__ ) . '" width="16" height="16" border="0" alt="Move Down"></a></span>';
							} else {
								$move_down = "";
							}
						}
