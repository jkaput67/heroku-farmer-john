...
/*        float:none;*/
/*        clear:both;*/
        width: <?php echo $portfolio_gallery_get_options["portfolio_gallery_ht_view5_main_image_width"];?>%;
    }
    #p-main-slider_<?php echo $portfolioID; ?> .slider-content-wrapper .right-block{
        width: <?php echo 98-$portfolio_gallery_get_options["portfolio_gallery_ht_view5_main_image_width"];?>%;
    }
}
</style>